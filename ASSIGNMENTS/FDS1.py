...
print("\nStudents who play Cricket: ", GroupA)
print("Students who play Badminton: ", GroupB)
print("Students who play Football: ", GroupC)
...
for i in GroupA:
    for j in GroupB:
        if i==j:
            AnB.add(i)
print("\n1. Students who play both cricket as well as badminton: ",AnB)
